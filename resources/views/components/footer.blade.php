<section id="footer " class="bg-black/65">
    <div class="pt-5">
        <div
            class="max-w-screen-lg px-4 sm:px-6 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto"
        >
            <div class="p-5">
                <h3 class="font-bold text-xl text-kuepres-primary">Printing</h3>
            </div>
            <div class="p-5">
                <div class="text-sm uppercase text-kuepres-primary font-bold">
                    Type setting
                </div>
                <a class="my-3 block text-gray-400" href="/#"
                    >Customer <span class="text-gray-400 text-xs p-1"></span></a
                ><a class="my-3 block text-gray-400" href="/#"
                    >Satisfaction
                    <span class="text-gray-400 text-xs p-1"></span></a
                ><a class="my-3 block text-gray-400" href="/#"
                    >Support
                    <span class="text-kuepres-hotpink text-xs p-1">New</span></a
                >
            </div>
            <div class="p-5">
                <div class="text-sm uppercase text-kuepres-primary font-bold">
                ...
                ><a class="my-3 block text-gray-400" href="/#"
                    >Privacy Policy </a
                ><a class="my-3 block text-gray-400" href="/#">Conditions </a>
            </div>
            <div class="p-5">
                <div class="text-sm uppercase text-kuepres-primary font-bold">
                    Contact us
                ...
                <a class="my-3 block text-gray-400" href="/#">
                    Opposite Young Christian International School, Paa Grant
                    Roundabout, Takoradi
                    <span class="text-teal-600 text-xs p-1"></span></a
                ><a class="my-3 block text-kuepres-white" href="/#"
                    >0536435100 <span class="text-teal-600 text-xs p-1"></span
                ></a>
            </div>
        </div>
    </div>
    ...
    <a href="/" target="_blank" class="block">
        <div class="flex items-center justify-center">
            <div class="h-20">
                <img
                    src="{{ asset('images/logo/KuePres-Logo2.png') }}"
