<div>
    <div class="container mx-auto mt-10">
        <div class="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p class="mt-4">Thank you for your order. Your order reference ID is <strong>{{ $reference }}</strong>.</p>
            ...
            <a href="{{ route('order-detail') }}" class="bg-gray-100 py-2 px-4 rounded-2xl hover:text-gray-400">Track Order</a>
        </div>
    </div>
</div>
